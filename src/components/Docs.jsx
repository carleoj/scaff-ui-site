...
function CommandBlock({ command }) {
  ...
  return (
    <div className="mt-5 flex items-center justify-between gap-3 rounded-md bg-zinc-600 px-4 py-3 text-sm text-white">
        ...
        >
          ...
          <div className="space-y-4">
            {steps.map((step) => (
              <article
                key={step.number}
                className="border rounded border-zinc-200 bg-zinc-50 p-6 sm:p-8"
              >
